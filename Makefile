...
help:
	...
	@echo "    stubmss_regression             Run a synthesis regression (single-threaded)"
	@echo "    stubmss_regression_par         Run a multi-threaded synthesis regression using GNU Parallel"
