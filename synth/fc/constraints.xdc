## Clock From Cora Z7 Devboard (generated by ethernet PHY on the board)
## We're not using this for the final result, rather we'll be using the PS-controllable FCLK
## However this may come in handy for debugging
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { i_raw_125mhz_clk }]; #IO_L13P_T2_MRCC_35 Sch=sysclk
create_clock -add -name raw_125mhz_clk -period 8.00 -waveform {0 4} [get_ports { i_raw_125mhz_clk }];#set
